...
// Uses Replit's AI Integrations proxy when AI_INTEGRATIONS_GEMINI_BASE_URL is set (e.g. on Replit);
// otherwise falls back to a direct Google AI Studio key against Google's default endpoint.
